...
const pendding = field => (field.mined && !field.flagged) || (!field.mined && !field.mined)

const endWinner = board => fields(board).filter(pendding).length === 0
...
export {createMinedBoard, cloneBoard, openField, hasExploded, endWinner, showMines, toggleFlag, flagsUsed}